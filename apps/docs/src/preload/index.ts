...
const api: DesktopApi = {
  ...
  listCompareDocs: () => ipcRenderer.invoke('docs:compare-list'),
  readCompareDocx: (id: string) => ipcRenderer.invoke('docs:compare-read', id),
  pickCompareDocx: () => ipcRenderer.invoke('docs:open'),
