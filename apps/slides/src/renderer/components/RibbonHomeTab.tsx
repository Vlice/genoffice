      ...
      <Group label={t('ribbonGroupFont')}>
        <div className="rb-col">
          ...
          <div className="rb-row">
            {(
              [
                ['bold', <b key="b">B</b>, t('ribbonBold'), curBold],
                ['italic', <i key="i">I</i>, t('ribbonItalic'), curItalic],
                ['underline', <u key="u">U</u>, t('ribbonUnderline'), curUnderline],
              ] as const
            ).map(([kind, label, title, on]) => (
              <button
                key={kind}
                className={`rb-icon${on === true ? ' active' : ''}`}
            ...
            <button
              className={`rb-icon${curStrike === true ? ' active' : ''}`}
              disabled={!editing && !hasSelection}
              data-tip={t('ribbonStrikethrough')}
              aria-pressed={curStrike === true}
              onMouseDown={(e) => {
                e.preventDefault()
