...
export const strings = {
  zh: {
    ...
    cloudSubtitle: '在网页端用 MoreAI 创建的项目。编辑在浏览器中继续——点击任意项目即可打开。',
  ...
  openLocal: '打开本地文件',
    ...
    rename: '重命名',
    duplicate: '创建副本',
    duplicatingTitle: '正在创建副本…',
    duplicatingHint: '大文件可能需要一点时间，请稍候',
    exportToLocal: '导出到本地',
    exportFailed: '导出失败',
    renameFailed: '重命名失败',
    emptyStarred: '还没有收藏 — 悬浮文件行并点击星标即可收藏。',
    emptyShared: '还没有与我共享的文档 — 他人分享后会出现在这里。',
    emptyRecent: '暂无最近文件 — 新建或打开一个文件开始使用。',
    emptyFiltered: '该类型下暂无文件。',
    // Delete confirmation dialog
    deleteModalTitle: '删除文件',
    deleteConfirmOne: '确定将「{name}」移到回收站？',
    ...
    projects: '项目',
    aiOutputs: 'AI 产物',
    aiSourceMyTasks: '我的任务',
    aiSourcePersonalAi: '个人助手',
    aiSourceChat: 'Chat',
    aiSourceAutomation: '自动化',
    officeAiModelTitle: '文档 AI 模型',
    officeAiModelHint: '用于云文档内的 AI 总结、润色与对话，不影响 Chat / 个人助手。',
    newProject: '新建项目',
    projectName: '项目名称',
    deleteProject: '删除项目…',
  ...
  en: {
    ...
    navCloud: 'Genspark Projects',
    cloudSubtitle:
      'Projects created on the web with MoreAI. Editing continues in your browser — click any project to open it.',
    ...
    pagerJump: 'Go to',
    pagerGo: 'Go',
    pagerPage: '{page} / {pages}',
    pagerAria: 'File list pagination',
    ...
    rename: 'Rename',
    duplicate: 'Duplicate',
    duplicatingTitle: 'Creating a copy…',
    duplicatingHint: 'Large files may take a moment. Please wait.',
    exportToLocal: 'Export to local',
    exportFailed: 'Export failed',
    renameFailed: 'Rename failed',
    emptyStarred: 'No starred files — hover a row and click the star.',
    emptyShared: 'No shared documents yet — files others share with you appear here.',
    ...
    delete: 'Delete',
    projects: 'Projects',
    aiOutputs: 'AI Artifacts',
    aiSourceMyTasks: 'My Tasks',
    aiSourcePersonalAi: 'Personal Assistant',
    aiSourceChat: 'Chat',
    aiSourceAutomation: 'Automation',
    officeAiModelTitle: 'Document AI model',
    officeAiModelHint:
      'Used for AI summarize, rewrite, and chat inside cloud docs. Does not change Chat or Personal Assistant.',
  ...
  ja: {
    ...
    navCloud: 'Genspark Projects',
    cloudSubtitle:
      'Web で MoreAI を使って作成したプロジェクト。編集はブラウザで続行します。クリックで開きます。',
    ...
    rename: '名前の変更',
    duplicate: '複製を作成',
    duplicatingTitle: 'コピーを作成しています…',
    duplicatingHint: '大きいファイルは少し時間がかかることがあります。',
    exportToLocal: 'ローカルにエクスポート',
    exportFailed: 'エクスポートに失敗しました',
    renameFailed: '名前の変更に失敗しました',
    emptyStarred:
      'お気に入りはまだありません — ファイルの行にカーソルを合わせて星マークをクリックしてください。',
    emptyShared: 'No shared documents yet.',
    ...
    projects: 'プロジェクト',
    aiOutputs: 'AI成果物',
    aiSourceMyTasks: 'マイタスク',
    aiSourcePersonalAi: 'パーソナルアシスタント',
    aiSourceChat: 'Chat',
    aiSourceAutomation: '自動化',
    newProject: '新規プロジェクト',
    projectName: 'プロジェクト名',
  ...
  ko: {
    ...
    navCloud: 'Genspark Projects',
    cloudSubtitle:
      'MoreAI로 웹에서 만든 프로젝트입니다. 편집은 브라우저에서 계속됩니다. 프로젝트를 클릭하면 열립니다.',
    ...
    rename: '이름 바꾸기',
    duplicate: '복사본 만들기',
    duplicatingTitle: '복사본을 만드는 중…',
    duplicatingHint: '큰 파일은 시간이 걸릴 수 있습니다. 잠시만 기다려 주세요.',
    ...
    projects: '프로젝트',
    aiOutputs: 'AI 산출물',
    aiSourceMyTasks: '내 작업',
    aiSourcePersonalAi: '개인 어시스턴트',
    aiSourceChat: 'Chat',
    aiSourceAutomation: '자동화',
    newProject: '새 프로젝트',
    projectName: '프로젝트 이름',
  ...
  fr: {
    ...
    navCloud: 'Genspark Projects',
    cloudSubtitle:
      "Projets créés sur le web avec MoreAI. L'édition continue dans votre navigateur — cliquez sur un projet pour l'ouvrir.",
    ...
    secAiFiles: 'Fichiers de session',
    ...
    rename: 'Renommer',
    duplicate: 'Dupliquer',
    duplicatingTitle: 'Création d’une copie…',
    duplicatingHint: 'Les fichiers volumineux peuvent prendre un moment.',
    exportToLocal: 'Exporter en local',
    ...
    // Project sidebar
    projects: 'Projets',
    aiOutputs: 'Artefacts IA',
    aiSourceMyTasks: 'Mes tâches',
    aiSourcePersonalAi: 'Assistant personnel',
    aiSourceChat: 'Chat',
    aiSourceAutomation: 'Automatisation',
  ...
  de: {
    ...
    navCloud: 'Genspark Projects',
    cloudSubtitle:
      'Mit MoreAI im Web erstellte Projekte. Die Bearbeitung läuft im Browser weiter – klicken Sie auf ein Projekt, um es zu öffnen.',
    ...
    duplicatingTitle: 'Kopie wird erstellt…',
    duplicatingHint: 'Große Dateien können einen Moment dauern.',
    exportToLocal: 'Lokal exportieren',
    ...
    // Project sidebar
    projects: 'Projekte',
    aiOutputs: 'KI-Artefakte',
    aiSourceMyTasks: 'Meine Aufgaben',
    aiSourcePersonalAi: 'Persönlicher Assistent',
    aiSourceChat: 'Chat',
    aiSourceAutomation: 'Automatisierung',
  ...
  es: {
    ...
    navShared: 'Compartidos',
    navCloud: 'Genspark Projects',
    cloudSubtitle:
      'Proyectos creados en la web con MoreAI. La edición continúa en tu navegador: haz clic en un proyecto para abrirlo.',
    ...
    duplicate: 'Duplicar',
    duplicatingTitle: 'Creando una copia…',
    duplicatingHint: 'Los archivos grandes pueden tardar un momento.',
    exportToLocal: 'Exportar a local',
    ...
    // Project sidebar
    projects: 'Proyectos',
    aiOutputs: 'Artefactos de IA',
    aiSourceMyTasks: 'Mis tareas',
    aiSourcePersonalAi: 'Asistente personal',
    aiSourceChat: 'Chat',
    aiSourceAutomation: 'Automatización',
  ...
  th: {
    ...
    navShared: 'แชร์กับฉัน',
    navCloud: 'Genspark Projects',
    cloudSubtitle:
      'โปรเจกต์ที่สร้างบนเว็บด้วย MoreAI แก้ไขต่อได้ในเบราว์เซอร์ — คลิกโปรเจกต์เพื่อเปิด',
    ...
    duplicatingTitle: 'กำลังสร้างสำเนา…',
    duplicatingHint: 'ไฟล์ขนาดใหญ่อาจใช้เวลาสักครู่',
    exportToLocal: 'ส่งออกไปยังเครื่อง',
    ...
    // Project sidebar
    projects: 'โปรเจ็กต์',
    aiOutputs: 'ผลลัพธ์ AI',
    aiSourceMyTasks: 'งานของฉัน',
    aiSourcePersonalAi: 'ผู้ช่วยส่วนตัว',
    aiSourceChat: 'Chat',
    aiSourceAutomation: 'ระบบอัตโนมัติ',
  ...
  id: {
    ...
    navCloud: 'Genspark Projects',
    cloudSubtitle:
      'Proyek yang dibuat di web dengan MoreAI. Pengeditan berlanjut di browser — klik proyek untuk membukanya.',
    ...
    rename: 'Ganti nama',
    duplicate: 'Duplikat',
    duplicatingTitle: 'Membuat salinan…',
    duplicatingHint: 'File besar mungkin memerlukan waktu sebentar.',
    exportToLocal: 'Ekspor ke lokal',
    ...
    // Project sidebar
    projects: 'Proyek',
    aiOutputs: 'Artefak AI',
    aiSourceMyTasks: 'Tugas saya',
    aiSourcePersonalAi: 'Asisten pribadi',
    aiSourceChat: 'Chat',
    aiSourceAutomation: 'Otomasi',
  ...
  ru: {
    ...
    navShared: 'Доступные мне',
    navCloud: 'Genspark Projects',
    cloudSubtitle:
      'Проекты, созданные в вебе с MoreAI. Редактирование продолжается в браузере — нажмите на проект, чтобы открыть его.',
    ...
    duplicatingTitle: 'Создание копии…',
    duplicatingHint: 'Крупные файлы могут занять немного времени.',
    exportToLocal: 'Экспорт на устройство',
    ...
    // Project sidebar
    projects: 'Проекты',
    aiOutputs: 'AI-артефакты',
    aiSourceMyTasks: 'Мои задачи',
    aiSourcePersonalAi: 'Личный помощник',
    aiSourceChat: 'Chat',
    aiSourceAutomation: 'Автоматизация',
  ...
  ar: {
    ...
    navCloud: 'Genspark Projects',
    cloudSubtitle:
      'مشاريع أُنشئت على الويب باستخدام MoreAI. يستمر التحرير في المتصفح — انقر على أي مشروع لفتحه.',
    ...
    duplicatingTitle: 'جارٍ إنشاء نسخة…',
    duplicatingHint: 'قد تستغرق الملفات الكبيرة بعض الوقت.',
    exportToLocal: 'تصدير إلى الجهاز',
    ...
    // Project sidebar
    projects: 'المشاريع',
    aiOutputs: 'مخرجات الذكاء الاصطناعي',
    aiSourceMyTasks: 'مهامي',
    aiSourcePersonalAi: 'المساعد الشخصي',
    aiSourceChat: 'Chat',
    aiSourceAutomation: 'الأتمتة',
  ...
  pt: {
    ...
    navShared: 'Compartilhados',
    navCloud: 'Genspark Projects',
    cloudSubtitle:
      'Projetos criados na web com o MoreAI. A edição continua no navegador — clique em um projeto para abri-lo.',
    ...
    rename: 'Renomear',
    duplicate: 'Duplicar',
    duplicatingTitle: 'Criando uma cópia…',
    duplicatingHint: 'Arquivos grandes podem demorar um pouco.',
    exportToLocal: 'Exportar para o dispositivo',
    ...
    delete: 'Excluir',
    projects: 'Projetos',
    aiOutputs: 'Artefatos de IA',
    aiSourceMyTasks: 'Minhas tarefas',
    aiSourcePersonalAi: 'Assistente pessoal',
    aiSourceChat: 'Chat',
    aiSourceAutomation: 'Automação',
  ...
  it: {
    ...
    navCloud: 'Genspark Projects',
    cloudSubtitle:
      'Progetti creati sul web con MoreAI. La modifica continua nel browser: fai clic su un progetto per aprirlo.',
    ...
    secAiFiles: 'File della sessione',
    ...
    rename: 'Rinomina',
    duplicate: 'Duplica',
    duplicatingTitle: 'Creazione di una copia…',
    duplicatingHint: 'I file di grandi dimensioni potrebbero richiedere un momento.',
    exportToLocal: 'Esporta in locale',
    ...
    delete: 'Elimina',
    projects: 'Progetti',
    aiOutputs: 'Artefatti IA',
    aiSourceMyTasks: 'I miei task',
    aiSourcePersonalAi: 'Assistente personale',
    aiSourceChat: 'Chat',
    aiSourceAutomation: 'Automazione',
  ...
  pl: {
    navRecent: 'Ostatnie',
    navStarred: 'Ulubione',
    navShared: 'Udostępnione',
    navCloud: 'Genspark Projects',
    cloudSubtitle:
      'Projekty utworzone w sieci za pomocą MoreAI. Edycja jest kontynuowana w przeglądarce — kliknij projekt, aby go otworzyć.',
    ...
    duplicatingTitle: 'Tworzenie kopii…',
    duplicatingHint: 'Duże pliki mogą chwilę potrwać.',
    exportToLocal: 'Eksportuj lokalnie',
    ...
    delete: 'Usuń',
    projects: 'Projekty',
    aiOutputs: 'Artefakty AI',
    aiSourceMyTasks: 'Moje zadania',
    aiSourcePersonalAi: 'Asystent osobisty',
    aiSourceChat: 'Chat',
    aiSourceAutomation: 'Automatyzacja',
  ...
  nl: {
    ...
    navCloud: 'Genspark Projects',
    cloudSubtitle:
      'Projecten gemaakt op het web met MoreAI. Bewerken gaat verder in je browser — klik op een project om het te openen.',
    ...
    duplicatingTitle: 'Kopie maken…',
    duplicatingHint: 'Grote bestanden kunnen even duren.',
    exportToLocal: 'Exporteren naar apparaat',
    ...
    delete: 'Verwijderen',
    projects: 'Projecten',
    aiOutputs: 'AI-artefacten',
    aiSourceMyTasks: 'Mijn taken',
    aiSourcePersonalAi: 'Persoonlijke assistent',
    aiSourceChat: 'Chat',
    aiSourceAutomation: 'Automatisering',
  ...
  ms: {
    ...
    navCloud: 'Genspark Projects',
    cloudSubtitle:
      'Projek yang dicipta di web dengan MoreAI. Penyuntingan diteruskan dalam pelayar — klik projek untuk membukanya.',
    ...
    duplicatingTitle: 'Mencipta salinan…',
    duplicatingHint: 'Fail besar mungkin mengambil sedikit masa.',
    exportToLocal: 'Eksport ke tempatan',
    ...
    delete: 'Padam',
    projects: 'Projek',
    aiOutputs: 'Artifak AI',
    aiSourceMyTasks: 'Tugas saya',
    aiSourcePersonalAi: 'Pembantu peribadi',
    aiSourceChat: 'Chat',
    aiSourceAutomation: 'Automasi',
  ...
  he: {
    ...
    navCloud: 'Genspark Projects',
    cloudSubtitle:
      'פרויקטים שנוצרו באינטרנט עם MoreAI. העריכה נמשכת בדפדפן — לחצו על פרויקט כדי לפתוח אותו.',
    ...
    duplicatingTitle: 'יוצר עותק…',
    duplicatingHint: 'קבצים גדולים עשויים לקחת רגע.',
    exportToLocal: 'ייצוא למחשב',
    ...
    projects: 'פרויקטים',
    aiOutputs: 'תוצרי AI',
    aiSourceMyTasks: 'המשימות שלי',
    aiSourcePersonalAi: 'עוזר אישי',
    aiSourceChat: 'Chat',
    aiSourceAutomation: 'אוטומציה',
  ...
  hi: {
    ...
    navCloud: 'Genspark Projects',
    cloudSubtitle:
      'MoreAI के साथ वेब पर बनाए गए प्रोजेक्ट। संपादन ब्राउज़र में जारी रहता है — खोलने के लिए किसी प्रोजेक्ट पर क्लिक करें।',
    ...
    duplicatingTitle: 'प्रतिलिपि बनाई जा रही है…',
    duplicatingHint: 'बड़ी फ़ाइलों में कुछ समय लग सकता है।',
    exportToLocal: 'स्थानीय में निर्यात करें',
    ...
    delete: 'हटाएँ',
    projects: 'प्रोजेक्ट',
    aiOutputs: 'AI आर्टिफ़ैक्ट',
    aiSourceMyTasks: 'मेरे कार्य',
    aiSourcePersonalAi: 'व्यक्तिगत सहायक',
    aiSourceChat: 'Chat',
    aiSourceAutomation: 'ऑटोमेशन',
  ...
  'zh-TW': {
    ...
    navShared: '与我共享',
    navCloud: 'Genspark Projects',
    cloudSubtitle: '在網頁端用 MoreAI 建立的專案。編輯在瀏覽器中繼續——點擊任意專案即可開啟。',
    ...
    rename: '重新命名',
    duplicate: '建立副本',
    duplicatingTitle: '正在建立副本…',
    duplicatingHint: '大檔案可能需要一點時間，請稍候',
    exportToLocal: '匯出到本機',
    exportFailed: '匯出失敗',
    renameFailed: '重新命名失敗',
    ...
    projects: '專案',
    aiOutputs: 'AI 產物',
    aiSourceMyTasks: '我的任務',
    aiSourcePersonalAi: '個人助手',
    aiSourceChat: 'Chat',
    aiSourceAutomation: '自動化',
    newProject: '新增專案',
    projectName: '專案名稱',
