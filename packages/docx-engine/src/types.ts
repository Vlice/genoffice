...
export interface TextboxDisplay {
  ...
  /**
   * WordArt preset id (e.g. 'white-red'). When set, the editor paints that
   * gallery fill and stroke. Persisted as wps:cNvPr name="WordArt:{id}" so a
   * reload restores it; the run color in OOXML stays a solid fallback.
   */
  wordArtId?: string
